// dll.h
// Windows dll interfaces for libjpgcomp
// Han Li 19/6/2020
...
DLLEXPORT extern JStatus compress(const char inData[], const char outData[]);

// default exceptions / info reporter
DLLEXPORT extern void checkStatus(JStatus statusNumber);
